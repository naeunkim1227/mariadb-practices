...
-- 문제3.전체 사원의 사번, 이름, 현재 부서를 이름 순서로 출력하세요..
 ...
 from employees a, departments d, dept_emp c
 where a.emp_no = c.emp_no
 and d.dept_no = c.dept_no and c.to_date = '9999-01-01'
 order by a.first_name asc;

-- 문제4.전체 사원의 사번, 이름, 연봉, 직책, 부서를 모두 이름 순서로 출력합니다.
select a.emp_no, a.first_name, c.salary, b.title, d.dept_name
...
select concat(c.first_name, ' ' , c.last_name) as '이름' , b.salary
...
select d.dept_name , avg(a.salary) as '평균연봉'
